...
public class SharedPrefsUtils {
    ...
    public Long getLastUpdateTime() {
        return sharedPrefs.getLong(App.getInstance().getString(R.string.shared_prefs_last_update_time), 0L);
    }

    public void setLastUpdateTime(Long lastUpdateTime) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putLong(App.getInstance().getString(R.string.shared_prefs_last_update_time), lastUpdateTime);
        editor.apply();
    }
    ...
    public String getMalUserId() {
        return sharedPrefs.getString(App.getInstance().getString(R.string.shared_prefs_mal_user_id), "");
    }

    public void setMalUserId(String malId) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putString(App.getInstance().getString(R.string.shared_prefs_mal_user_id), malId);
        editor.apply();
    }

    public String getMalUsernameFormatted() {
        return sharedPrefs.getString(App.getInstance().getString(R.string.shared_presfs_mal_username_formatted), "");
    }

    public void setMalUsernameFormatted(String malUsernameFormatted) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putString(App.getInstance().getString(R.string.shared_presfs_mal_username_formatted), malUsernameFormatted);
        editor.apply();
    }

    public String getUsername() {
        return sharedPrefs.getString(App.getInstance().getString(R.string.shared_prefs_credentials_username), "");
    }

    public void setUsername(String username) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putString(App.getInstance().getString(R.string.shared_prefs_credentials_username), username);
        editor.apply();
    }

    public String getPassword() {
        return sharedPrefs.getString(App.getInstance().getString(R.string.shared_prefs_credentials_password), "");
    }

    public void setPassword(String password) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putString(App.getInstance().getString(R.string.shared_prefs_credentials_password), password);
        editor.apply();
    }


    // Preferences (SettingsFragment)
