...
public class SeasonDeserializeTask extends AsyncTask<JsonElement, Void, Season> {

    private static final String TAG = SeasonDeserializeTask.class.getSimpleName();
    ...
    @Override
    protected Season doInBackground(JsonElement... jsonElements) {
        return deserialize(jsonElements[0]);
    }

    private Season deserialize(JsonElement json){
