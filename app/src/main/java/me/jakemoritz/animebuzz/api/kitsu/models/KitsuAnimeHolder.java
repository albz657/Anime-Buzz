package me.jakemoritz.animebuzz.api.kitsu.models;
...
public class KitsuAnimeHolder {
    ...
    public KitsuAnimeHolder(String englishTitle, String imageURL, String finishedAiringDate, String startedAiringDate, String showType, int episodeCount, String kitsuId) {
